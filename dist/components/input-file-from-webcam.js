...
const Camera = registerPlugin('Camera', {
    web: () => import('./web.js').then(m => new m.CameraWeb()),
});
...
export { CameraSource as C, InputFileFromWebcam, WebPlugin as W, CameraDirection as a, CapacitorException as b, defineCustomElement };
