...
const InputFaceApiWebcam$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  ...
  get el() { return this; }
  static get style() { return inputFaceApiWebcamCss; }
}, [1, "input-face-api-webcam", {
    "photoPicMinValue": [1538, "photo-pic-min-value"],
    "width": [1538],
    "height": [1538],
    "isDetecting": [32],
    "stopDetection": [64],
...
function defineCustomElement$1() {
  ...
  const components = ["input-face-api-webcam"];
  components.forEach(tagName => { switch (tagName) {
    case "input-face-api-webcam":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, InputFaceApiWebcam$1);
      }
      break;
  } });
}

const InputFaceApiWebcam = InputFaceApiWebcam$1;
const defineCustomElement = defineCustomElement$1;

export { InputFaceApiWebcam, defineCustomElement };
