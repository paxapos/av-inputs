import { consoleError, proxyCustomElement, HTMLElement, createEvent, h as h$1, Host } from '@stencil/core/internal/client';
import { v as videoToBlob, C as CameraDirection, i as initWebcamToVideo, c as createVideo, a as createCanvas, r as renderToCanvas } from './camera.service.js';
...
const workerPromise = import('./distance.worker.js').then(m => m.worker);
...
const InputFaceApiWebcam$1 = /*@__PURE__*/ proxyCustomElement(class InputFaceApiWebcam extends HTMLElement {
    ...
    static get style() { return inputFaceApiWebcamCss; }
        ...
        "enableDetection": [1540, "enable-detection"],
        "showControls": [4, "show-controls"],
        "autoStart": [4, "auto-start"],
        "showBoundingBoxes": [4, "show-bounding-boxes"],
        "showLandmarks": [4, "show-landmarks"],
        "startButtonText": [1, "start-button-text"],
        "stopButtonText": [1, "stop-button-text"],
        "flipButtonText": [1, "flip-button-text"],
        "trainedModel": [16, "trained-model"],
        "width": [1538],
        "height": [1538],
        "scoreThreshold": [1538, "score-threshold"],
        "detectionTimer": [1538, "detection-timer"],
        "facingMode": [1537, "facing-mode"],
        "autoCapture": [4, "auto-capture"],
        "captureThreshold": [2, "capture-threshold"],
        "captureDelay": [2, "capture-delay"],
        "detectionResult": [32],
        "loaded": [32],
        "cameraState": [32],
        "currentError": [32],
        "detectedFacesCount": [32],
        "isRecognizing": [32],
        "stopDetection": [64],
        "startDetection": [64],
        "toggleCamera": [64],
...
export { InputFaceApiWebcam, createWorker as c, defineCustomElement };
