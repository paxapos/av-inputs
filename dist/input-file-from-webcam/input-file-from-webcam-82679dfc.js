import { r as registerInstance, e as createEvent, h, f as Host, g as getElement } from './index-c47c5e69.js';
...
const Camera = registerPlugin('Camera', {
    web: () => import('./web-03936a30.js').then(m => new m.CameraWeb()),
});
...
class WebCamera {
  ...
  async initCamera(parentElement, direction, drawImageCb = null) {
    ...
    if (navigator.mediaDevices.getUserMedia) {
      const facingMode = (direction == CameraDirection.Front) ? { exact: "user" } : { exact: "environment" };
...
const InputFileFromWebcam = class {
  ...
  render() {
    return (h(Host, null, h("slot", { name: 'before' }), h("slot", null), h("slot", { name: 'after' })));
  }
...
//# sourceMappingURL=input-file-from-webcam-82679dfc.js.map