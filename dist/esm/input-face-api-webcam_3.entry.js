import { g as getAssetPath, r as registerInstance, c as createEvent, h as h$1, H as Host, a as getElement } from './index-e2963afb.js';
...
const InputScanReader = class {
  ...
  render() {
    return (h$1(Host, null, h$1("input", { type: "text", value: this.scannedText })));
  }
  get el() { return getElement(this); }
};
InputScanReader.style = inputScanReaderCss;

export { InputFaceApiWebcam as input_face_api_webcam, InputFileFromWebcam as input_file_from_webcam, InputScanReader as input_scan_reader };

//# sourceMappingURL=input-face-api-webcam_3.entry.js.map