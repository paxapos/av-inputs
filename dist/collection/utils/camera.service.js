...
export function videoToCanvas(video, box) {
...
export function videoToBlob(video, box, compression = 0.85) {
  return new Promise((resolve, reject) => {
    try {
...
export function renderToCanvas(canvas, video, drawImageCb) {
...
export async function takePicture(canvas, compression = 0.85) {
  return new Promise((resolve, reject) => {
    try {
      canvas.toBlob((blob) => {
