...
const InputScanReader = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("input", { type: "text", value: this.scannedText })));
  }
  get el() { return index.getElement(this); }
};
...
exports.input_scan_reader = InputScanReader;

//# sourceMappingURL=input-face-api-webcam_3.cjs.entry.js.map