...
const InputScanReader = class {
    ...
    onEnterHandler() {
        ...
        const scannedData = text_handler.processText(this.scannedText);
    ...
    async getData() {
        ...
        return text_handler.processText(this.scannedText);
    }
    reset() {
        this.scannedText = '';
        this.readingEnabled = false;
    ...
    spanLoader() {
        return index.h("span", { class: "loader" });
    }
    render() {
        ...
        return (index.h(index.Host, { key: 'dc6eaa6bd56ab40e65f83fd530aa8d7eaafba86f' }, index.h("div", { key: '566932dbaff5a62dd86f105adfc24de5923e6792', class: mainClass }, index.h("div", { key: 'd324de05faeea3789c0052bbf0cf22fd5719c8b1' }, this.spanLoader()), this.scanTitle && index.h("label", { key: 'a26446f146e54dd297e893de39deef1ad5cbc1e6' }, this.scanTitle), index.h("div", { key: '236536404992cc01224de4cc216a3a5a8dd616cb', class: "scanned-text" }, this.scannedText), index.h("input", { key: 'c798b9be1a8510264eda28208a745ea7adb94607', type: "text", value: this.scannedText, onChange: ev => this.handleOnInpujtChangeEvent(ev) }))));
    }
...
//# sourceMappingURL=input-scan-reader.entry.cjs.js.map

//# sourceMappingURL=input-scan-reader.cjs.entry.js.map