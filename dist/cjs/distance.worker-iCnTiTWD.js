...
var inputFaceApiWebcam_entry = require('./input-face-api-webcam-n0WJNP3O.js');
require('./index-DgaZvN-T.js');
require('./camera.service-BQZZ7IZj.js');

const workerName = 'distance.worker';
const workerMsgId = 'stencil.distance.worker';
const workerPath = (typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__dirname + '/distance.worker-BL-2OZ-1.js').href : new URL('distance.worker-BL-2OZ-1.js', document.currentScript && document.currentScript.tagName.toUpperCase() === 'SCRIPT' && document.currentScript.src || document.baseURI).href);
...
//# sourceMappingURL=distance.worker-iCnTiTWD.js.map
