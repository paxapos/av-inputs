...
| `facingMode`  | `facing-mode` | FacingModel optiones following https://developer.mozilla.org/en-US/docs/Web/API/MediaTrackConstraints/facingMode#value                                                                                                                                                                                                                        | `"environment" \| "user"` | `"user"` |
...
| ------------------- | ----------- | -------------------------------------- |
| `facingModeChanged` |             | `CustomEvent<"environment" \| "user">` |
